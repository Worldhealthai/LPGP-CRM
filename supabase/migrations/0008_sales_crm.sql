-- ===========================================================================
-- LPGP Connect CRM — sales layer
--
-- Turns the lead list into a working sales CRM:
--   accounts          — sponsors we've won, the thing a POC hangs off
--   account_contacts  — points of contact per sponsor
--   activities        — call/email/meeting log that powers every timeline
--   tasks             — follow-ups and callbacks
--   ops_links         — a confirmed link from a CRM record to a deal in the
--                       TrackerLPGP ops panel, with a snapshot so the UI still
--                       has something to show when the bridge is unreachable
--   lead_imports      — one row per spreadsheet import, for undo/audit
--
-- Run AFTER 0007_crm.sql. Safe to re-run.
-- ===========================================================================
